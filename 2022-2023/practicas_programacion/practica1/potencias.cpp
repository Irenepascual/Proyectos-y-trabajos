...
int main() {   
    const int ANCHO = 7;
    cout << right << setw(ANCHO) << "x" << right << setw(ANCHO) << "x^2" << right << setw(ANCHO) << "x^3" << endl;
    cout << right << setw(ANCHO) << "===" << right << setw(ANCHO) << "===" << right << setw(ANCHO) << "===" << endl;
    ...
    for (int x = 1; x <= 24; x++) {
        cout << right << setw(ANCHO) << x << right << setw(ANCHO) <<  x * x << right << setw(ANCHO) << x * x * x << endl;
    }
}
