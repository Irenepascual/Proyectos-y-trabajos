...
int main() {
    const int ANCHO = 9;
    cout << right << setw(ANCHO) << "Grados" 
    << right << setw(ANCHO) << "Radianes" 
    << right << setw(ANCHO) << "Seno" 
    << right << setw(ANCHO) << "Coseno"
         << endl;
    ...
    for (double grados = 0; grados <= 180; grados += 10) {
        ...
        cout << setprecision (0) << right << setw(ANCHO) << grados 
             << setprecision(4) << right << setw(ANCHO) << radianes
             << right << setw(ANCHO) << sin(radianes) 
             << right << setw(ANCHO) << cos(radianes) << endl;
    }
}
