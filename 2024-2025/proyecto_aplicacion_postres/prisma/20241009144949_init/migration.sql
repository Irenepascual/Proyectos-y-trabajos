...
CREATE TABLE "Receta" (
    ...
    CONSTRAINT "Receta_pkey" PRIMARY KEY ("nom_usuario_r","nom_receta")
);
...
CREATE TABLE "Utiliza" (
    ...
    CONSTRAINT "Utiliza_pkey" PRIMARY KEY ("nom_usuario_i_ut","nom_ingred_ut","nom_usuario_r_ut","nom_receta_ut")
);
...
-- AddForeignKey
ALTER TABLE "Utiliza" ADD CONSTRAINT "Utiliza_nom_usuario_r_ut_nom_receta_ut_fkey" FOREIGN KEY ("nom_usuario_r_ut", "nom_receta_ut") REFERENCES "Receta"("nom_usuario_r", "nom_receta") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Favoritos" ADD CONSTRAINT "Favoritos_nom_usuario_r_f_nom_receta_f_fkey" FOREIGN KEY ("nom_usuario_r_f", "nom_receta_f") REFERENCES "Receta"("nom_usuario_r", "nom_receta") ON DELETE RESTRICT ON UPDATE CASCADE;
