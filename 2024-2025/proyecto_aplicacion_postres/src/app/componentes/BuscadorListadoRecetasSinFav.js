// src/app/components/BuscadorListadoRecetas.js
'use client';
import React, { useEffect, useState } from 'react';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faPeopleGroup, faClock, faMagnifyingGlass } from '@fortawesome/free-solid-svg-icons';
...
/*
* Devuelve el componente RecetasListSinFav, donde se cargan las
* recetas, ingredientes y restricciones, se permite la 
* búsqueda por nombre y filtrado de restricciones y NO
* gestiona los favoritos.
*/
export default function RecetasListSinFav() {
    ...
    const fetchIngredientes = async () => {
        try {
            const response = await fetch('/routes/ingredientes?estado=aprobado');
                            ...
                            recetas.map((receta) => {
                                ...
                                return (
                                    <div className='receta-item' key={`${receta.nom_receta}-${receta.nom_usuario_r}`}>
                                        <p class="receta-nombre">{receta.nom_receta}</p>
