...
* se marca como no aprobado (por ser receta creada por el usuario).
*/
        ...
        <div>
            ...
            {showSuccessMessage && (
                <div className="popup-OK">
                    ...
                    <p>Puedes consultar tu receta en el apartado "Mis Recetas"</p>
                    <p>Cuando el propietario apruebe tu receta, aparecerá en la página principal de la aplicación</p>
                </div>
            )}
            ...
            {paso === 3 && selectedIngredientes.length === 0 && setPaso(4)}
