...
public class NodeExpander {
	...
	public static final String nodesGenerated ="nodesGenerated";
	public NodeExpander() {
		metrics = new Metrics();
	}
	...
	public List<Node> expandNode(Node node, Problem problem) {
		...
		for (Action action : actionsFunction.actions(node.getState())) {
			...
			metrics.set(nodesGenerated,
					metrics.getInt(nodesGenerated) + 1);
		}
