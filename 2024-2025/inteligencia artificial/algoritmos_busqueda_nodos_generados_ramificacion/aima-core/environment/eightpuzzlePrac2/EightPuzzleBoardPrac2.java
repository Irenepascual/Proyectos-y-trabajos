 ...
 * @author R. Lunde
 */
public class EightPuzzleBoardPrac2 {
	...
	public EightPuzzleBoardPrac2() {
		state = new int[] { 5, 4, 0, 6, 1, 8, 7, 3, 2 };
	}

	public EightPuzzleBoardPrac2(int[] state) {
		this.state = new int[state.length];
		System.arraycopy(state, 0, this.state, 0, state.length);
	}

	public EightPuzzleBoardPrac2(EightPuzzleBoardPrac2 copyBoard) {
	...
	public boolean equals(Object o) {
		...
		EightPuzzleBoardPrac2 aBoard = (EightPuzzleBoardPrac2) o;
